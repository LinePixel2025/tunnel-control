...
import { Activity, Cable, Check, CirclePlus, Computer, Copy, KeyRound, LogIn, Pencil, Power, RefreshCw, ShieldCheck, Trash2 } from "lucide-react";
...
function TunnelsPanel({ tunnels, devices, onToggle, onEdit, onDelete, onCreate }: { tunnels: Tunnel[]; devices: Device[]; onToggle: (id: string) => void; onEdit: (tunnel: Tunnel) => void; onDelete: (tunnel: Tunnel) => void; onCreate: () => void }) {
